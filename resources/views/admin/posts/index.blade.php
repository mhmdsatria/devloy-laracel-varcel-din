...
<div class="container mx-auto p-5">
    <h1 class="text-3xl font-bold mb-5">Daftar Berita</h1>

    <!-- Tombol Tambah -->
    <a href="{{ route('admin.posts.create') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">
        + Tambah Berita
    </a>

    <!-- Notifikasi sukses -->
    @if(session('success'))
        <div class="bg-green-100 text-green-700 px-4 py-2 mt-4 rounded-md">
            {{ session('success') }}
        </div>
    @endif
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="border px-4 py-2 text-center flex justify-center gap-2">
                        <a href="{{ route('admin.posts.edit', $post->id) }}" class="bg-yellow-500 hover:bg-yellow-600 text-white px-3 py-1 rounded-md">Edit</a>
